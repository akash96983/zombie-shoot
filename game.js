...
function createZombie(){
    ...
    let number = helpRandomInteger(1,6);
    ...
    zombie.style.transform = `translateX(${helpRandomInteger(20,80)}vw)`
    zombie.style.animationDuration = `${helpRandomInteger(2,6)}s`
...
function helpRandomInteger(min,max){
